...
void backlight_set(uint8_t level)
{
	...
	{
		0,
		_BV(CLUE_LED_ESCAPE) | _BV(CLUE_LED_INSERT) | _BV(CLUE_LED_ARROWS),
		_BV(CLUE_LED_ARROWS),
		_BV(CLUE_LED_INSERT),
		_BV(CLUE_LED_ESCAPE),
		_BV(CLUE_LED_ARROWS) | _BV(CLUE_LED_INSERT),
		_BV(CLUE_LED_INSERT) | _BV(CLUE_LED_ESCAPE),
		_BV(CLUE_LED_ESCAPE) | _BV(CLUE_LED_ARROWS)
	};
